### Sakura | LP module
>Sakura module позволяет управлять разными функциями VK из любого чата.
---
## Навигация
...
|  *  | `{TOKENVKA}` |  Токен VK Admin      |  *  |
|  *  | `{TOKENVKS}` |    Токен Sakura      |  *  |
* [⬆️Навигация](#Навигация)
---
# Установка
## Получаем токен [VK Admin](https://vk.cc/ckkSO0).
- Листаем в самый низ, нажимаем [Разрешить].
- Копируем то-что находится в URL адресе страницы.
### Переходим в личные сообщения с [группой](https://vk.com/skr.community).
- Пишем - `/create`
- - Получаем - ✅ &#60;SKRLP Module&#62; Session created.
- Пишем - `/vka {ENTER} {TOKENKATE}`
- - Получаем - ✅ &#60;SKRLP Module&#62; Token VKA updated.
- Пишем - `/restart`
- - Получаем - ✅ &#60;SKRLP Module&#62; Session restarted.
### Проверяем - `{CPREFIX}` инфо
## Получаем токен [Sakura](https://vk.com/skr.community).
- Отключаем 2Хфакторную аутентификацию.
- Вспоминаем логин и пароль от страницы.
### Переходим в личные сообщения с [группой](https://vk.com/skr.community).
- Пишем - `/stop`
- - Получаем - ✅ &#60;SKRLP Module&#62; Session stopped.
- Пишем - `/vks {ENTER} {LOGIN} {ENTER} {PASS}`
- - Получаем - ✅ &#60;SKRLP Module&#62; Token VKS updated.
- Пишем - `/restart`
- - Получаем - ✅ &#60;SKRLP Module&#62; Session restarted.
### Проверяем - `{CPREFIX}` инфо
* [⬆️Навигация](#Навигация)
...
---
## По всем вопросам ✅ 
1. [Ульяна Смирнова](https://vk.com/id67889141)
2. [Даниил Трофимов](https://vk.com/skrstaff)
3. [Владислав Бабиков](https://vk.com/hackingassistant)
4. [Роман Алексеевич](https://vk.com/speeer)
>Все ссылки кликабельны.
---
* [⬆️Навигация](#Навигация)
